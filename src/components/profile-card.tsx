...
const DEFAULT_INNER_GRADIENT = 'var(--pc-inner-gradient)';
...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  ...
  const cardStyle = useMemo(
    () => ({
      ...
      '--behind-glow-color': behindGlowColor ?? 'var(--pc-glow-color)',
        ...
        >
          <div
            ...
            style={{
              ...
              backgroundColor: 'var(--pc-base)',
              borderRadius: cardRadius,
              display: 'grid',
              gridArea: '1 / -1'
            }}
          >
            {/* Shine layer — only when a mask icon is supplied; otherwise the
                repeating-linear-gradient fills the card as raw horizontal bands */}
